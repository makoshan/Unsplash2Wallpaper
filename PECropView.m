...
static const CGFloat MarginTop = 44.0f;
...
- (void)commonInit
{
    ...
    self.scrollView.maximumZoomScale = 1.54f;
    self.scrollView.minimumZoomScale=1.54f;
...
- (void)setShowsGridMajor:(BOOL)showsGridMajor
{
    ...
    self.cropRectView.showsGridMajor=_showsGridMajor;
