...
@interface PECropViewController : UIViewController<UIGestureRecognizerDelegate>
...
- (void)cropViewController:(PECropViewController *)controller didFinishCroppingImage:(UIImage *)croppedImage btn:(UIButton *)button;
